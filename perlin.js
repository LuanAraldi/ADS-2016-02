...
(function(global){
  ...
  module.seed = function(seed) {
    if(seed > 0 && seed < 1) {
      // Limita a seed a 2^16 (acredito que nao precise mais que isso)
      seed *= 65536;
    }
  ...
  // Constantes da fórmula Simplex
  var F3 = 1/3;
  var G3 = 1/6;

  module.simplex3 = function(xin, yin, zin) {
    var n0, n1, n2, n3; // Quatro pontos do tetraedo

    // Vasculha o espaço determinando em qual parte do simplex esta o cursor
    var s = (xin+yin+zin)*F3;
    var i = Math.floor(xin+s);
    var j = Math.floor(yin+s);
    var k = Math.floor(zin+s);

    // Distâncias x,y iniciais
    var t = (i+j+k)*G3;
    var x0 = xin-i+t;
    var y0 = yin-j+t;
    var z0 = zin-k+t;
    ...
    // Coordenadas do tetraedo para a formula
    if(x0 >= y0) {
      if(y0 >= z0){ 
        i1=1; 
        j1=0; 
    ...
    // O retorno é calculado para que retorne valores entre -1 e 1
